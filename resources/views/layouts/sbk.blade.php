    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        @includewhen(isset($notification)? $notification: false, 'partials.notification')
                        <!-- ============================================================== -->
                        <!-- End Comment -->
                        <!-- ============================================================== -->
                        @includewhen(isset($email)? $email: false, 'partials.email')
                        ...
                        <!-- language -->
                        @includewhen(isset($lang)? $lang: false, 'partials.lang')
                    </ul>
                </div>
            </nav>
        </header>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Right sidebar -->
                <!-- ============================================================== -->
                @includewhen(isset($right)? $right: false, 'partials.rightSlider')
                <!-- ============================================================== -->
                <!-- End Right sidebar -->
                <!-- ============================================================== -->
            </div>
