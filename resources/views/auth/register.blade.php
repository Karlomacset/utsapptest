...
<head>
    ...
    <title>UTS Application templates</title>
    ...
    <div class="card-body">
      <form class="form-horizontal form-material" id="loginform" action="{{url('/regnewclient')}}" method="POST">
        ...
        <div class="form-group mt-3">
          <div class="col-xs-12">
            <input class="form-control" type="text" required="" name="companyName" placeholder="Company Name">
          </div>
        </div>
        ...
        <div class="form-group mb-0">
          <div class="col-sm-12 text-center">
            Already have an account? <a href="/login" class="text-info ml-1"><b>Sign In</b></a>
          </div>
        </div>
      </form>
    </div>
